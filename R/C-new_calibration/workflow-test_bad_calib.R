...
scenarios_df <- tibble(
  ...
  .at = 1,
  prep.start.rate_1 = 0.00589763,
  prep.start.rate_2 = 0.004475317,
  prep.start.rate_3 = 0.006644031,
  hiv.test.rate_1 = 0.0006492523,
  hiv.test.rate_2 = 0.001134663,
  hiv.test.rate_3 = 0.000689151,
  tx.halt.rate_1 = 0.002210675,
  tx.halt.rate_2 = 0.002018542,
  tx.halt.rate_3 = 0.001337948,
  hiv.trans.scale_1 = 3.206223,
  hiv.trans.scale_2 = 0.5821538,
  hiv.trans.scale_3 = 0.4400807,
  gono.uret.prob = 0.2049611,
  chla.uret.prob = 0.1354086,
  syph.prob = 0.1307145,
  aids.off.tx.mort.rate = 0.0005607647,
  a.rate = 0.0004228183
)

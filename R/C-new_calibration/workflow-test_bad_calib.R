...
scenarios_df <- tibble(
  ...
  .at = 1,
  prep.start.rate_1 = 0.00585517,
  prep.start.rate_2 = 0.00446246,
  prep.start.rate_3 = 0.006679832,
  hiv.test.rate_1 = 0.0007373561,
  hiv.test.rate_2 = 0.001078006,
  hiv.test.rate_3 = 0.000687039,
  tx.halt.rate_1 = 0.002239908,
  tx.halt.rate_2 = 0.002076526,
  tx.halt.rate_3 = 0.001342886,
  hiv.trans.scale_1 = 3.254464,
  hiv.trans.scale_2 = 0.6241976,
  hiv.trans.scale_3 = 0.4572148,
  gono.uret.prob = 0.2035098,
  chla.uret.prob = 0.1337475,
  syph.prob = 0.1297427,
  aids.off.tx.mort.rate = 0.0005489345,
  a.rate = 0.000421533
)
